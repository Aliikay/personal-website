...
I decided to create my own theme and template for this website instead of using an existing one as an opportunity to get more in the weeds with Zola's template system. The colour scheme I chose is original, but takes significant inspiration from [Nyx8 Palette](https://lospec.com/palette-list/nyx8).

I made the initial design for the website in [Inkscape](https://inkscape.org/), which is an open-source design program similar to Figma.

*This website, as well as all of my projects, has been created with **absolutely no AI**.*
