...
video = "trailer"
+++
Slipstream is a top-down racing game where you control a bubble. It's momentum based, so you click to eject a small bubble from yourself and get pushed in the opposite direction with no friction, until you bounce off of a wall. Each time you shoot off a part of yourself you shrink in size, and when you run into bubbles from other people you can absorb them into yourself to grow. We started development of this game as a submission to the Global Game Jam 2025, and I've been developing this game as part of [Daisy Chain Games](https://daisychaingames.ca/) as a Programmer and UI Designer. 
