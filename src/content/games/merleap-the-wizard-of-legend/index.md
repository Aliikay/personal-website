...
external_icon = "itch"
+++
This was a game jam game made in 48 hours for the Games Den Quickening game jam. It's a bullet heaven game where you play as the last frog with magic, in a post-apocalypse where the world has been taken over by machines.
...
{{ article_image(name="projectile-resource.png", width=1000, height=1000, op="fit", description="The projectile resource for Reflective Orb, with it's exposed data properties. Projectile objects will get passed this resource, which informs it how to behave.")}}
